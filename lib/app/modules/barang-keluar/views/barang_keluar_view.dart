...
class BarangKeluarView extends GetView<BarangKeluarController> {
  ...
  // Tema warna disesuaikan (Orange untuk membedakan dengan Barang Masuk)
        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [warningOrange, lightOrange],
            ),
          ),
        ),
        leading: IconButton(
              ...
              children: [
                Container(
                  ...
                  child: Icon(Icons.arrow_upward_rounded,
                      size: 60, color: warningOrange.withOpacity(0.5)),
                ),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (data == null) {
                            ...
                            controller.updateBarangKeluar(data['id'],
                                barangId, tanggal, jumlahC.text);
                          }
                          Get.back();
                        },
  ...
  Widget _buildDropdown<T>({
    ...
    return DropdownButtonFormField<T>(
      ...
      decoration: InputDecoration(
        prefixIcon: Icon(icon, color: warningOrange),
        hintText: hint,
        ...
        focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(14),
            borderSide:
                const BorderSide(color: warningOrange, width: 2)),
